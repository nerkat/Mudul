...
EdTech Branch (Teachers ↔ Students)

Extend Mudul node model into education.

Nodes: Teacher, Student, Classroom, Test/Quiz, Submission.

Teacher Dashboard: class overview, student performance, notes, awards.

Student Dashboard: quizzes/tests, submission history, feedback.

Analyzer: AI-powered scoring + feedback for teacher approval.

Long-term: positions Mudul as universal OrgOS for any human system.
...
EdTech MVP: Model Classroom/Teacher/Student/Test nodes; Teacher creates test, Student submits; Analyzer suggests notes.
