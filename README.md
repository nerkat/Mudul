...
4. Structured analysis is stored with interaction metadata.
5. The validated output becomes product UI and workflow state.

## Conversation intelligence demo context
...
Use the root [`.env.example`](.env.example) or the package-specific examples as templates for local setup.
